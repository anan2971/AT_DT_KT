...
from omni_anomaly.utils import get_data_dim, get_data, get_data1,get_data2, save_z
...
def main():
    ...
    (x_train, _), (x_test, y_test) = \
        get_data1(config.dataset, config.max_train_size, config.max_test_size, train_start=config.train_start,
